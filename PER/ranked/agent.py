...
class DQN:
    def __init__(
        ...
        self.memory = MaxHeap(mem_size, batch_size, alpha_PER, beta_PER, rebalance_iter)
    ...
    def sample_memory(self):
        ...
        new_states = np.array([row[3] for row in sarsd])
        terminals = np.array([row[4] for row in sarsd])
