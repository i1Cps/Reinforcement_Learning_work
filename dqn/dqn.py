...
class DQN:
    ...
    def store_transition(self, state, action, reward, new_state, terminal, truncated):
        self.memory.store_transition(
            state, action, reward, new_state, terminal, truncated
        )
    ...
    def learn(self):
        ...
        loss = self.q_network_eval.loss(Q, Q_target).to(self.q_network_eval.device)
        loss.backward()
