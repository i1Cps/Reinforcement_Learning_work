...
class ContinuousActorNetwork(nn.Module):
    def __init__(
        self, input_dims, n_actions, alpha, fc1=128, fc2=128, chkpt_dir="models/"
    ):
        super(ContinuousActorNetwork, self).__init__()
        self.checkpoint_file = os.path.join(chkpt_dir, "actor_continous_ppo")
...
class ContinuousCriticNetwork(nn.Module):
    def __init__(self, input_dims, alpha, fc1=128, fc2=128, chkpt_dir="model/"):
